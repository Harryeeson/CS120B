...
tests = [ {'description': 'PINA: 1 => PORTB: 0x00',
    'steps': [ {'inputs': [('PINA',0x01)], 'iterations': 2 }],
    'expected': [('PORTB', 0x00)],
    },
    {'description': 'PINA: 2 => PORTB: 0x00',
    'steps': [ {'inputs': [('PINA',0x02)], 'iterations': 2 }],
    'expected': [('PORTB', 0x00)],
    },
    {'description': 'PINA: 4, 0, 1, 0, 2, 0, 1, 0 => PORTB: 0x01',
