 ...
 *
 * 	Demo Link: https://drive.google.com/file/d/1dLgPn19QFjfVMpJkebe4eC31wMfOaMIT/view?usp=sharing
 *	Note: The LED lights in the video recording appear a lot dimmer in the video than they should  
 *	      be
 */
#include <avr/io.h>
#include "timer.h"
